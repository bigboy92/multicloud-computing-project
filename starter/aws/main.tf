    ...
    "environment": [
      {
        ...
        "value": "udacity-bigboy-azure-sql"
      },
      {
        "name": "AZURE_DOTNET_APP",
        "value": "udacity-bigboy-azure-dotnet-app"
      }
    ],
    "portMappings": [
      {
...
resource "aws_dynamodb_table" "bigboy-dynamodb-table" {
  name           = "GameScores"
  ...
  tags = {
    Name        = "bigboy-dynamodb"
    Environment = "production"
  }
}
resource "aws_s3_bucket" "my_bucket" {
  bucket = "udacity-bigboy-aws-s3-bucket"

  tags = {
    Name        = "udacity-bigboy-aws-s3-bucket"
    Environment = "Dev"
  }
}